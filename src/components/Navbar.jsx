...
export default function Navbar() {
    ...
    return (
        <nav className='max-lg:px-4 flex items-center justify-between px-16 py-6 bg-background'>
            <div className='flex flex-col'>
                <div className='flex items-center gap-2'>
                    <h1 className='text-accent text-3xl font-display font-bold leading-none'>RBI</h1>
                    <span className='max-md:hidden text-base text-2xl font-light'>by household</span>
                </div>
                <p className='max-md:hidden text-base-light text-sm'>Record of Barangay Inhabitants</p>
            </div>
            ...
            <div className='flex items-center gap-12'>
                <div className='flex bg-base-light/5 p-1 rounded-lg'>
                    ...
                    >
                        {historyIcon} 
                        <div className='max-md:hidden'>History</div>
                    </NavLink>
                </div>
