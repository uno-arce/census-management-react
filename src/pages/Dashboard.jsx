...
export default function Dashboard() {
    const { records, totalRecords, searchQuery, searchColumn, currentPage, rowsPerPage } = useCensus()
            ...
            <main className='px-16 flex flex-col gap-2 flex-1'>
                <div className='flex justify-between items-end border-t border-base-light/20 pt-8'>
                    ...
                    <div className='flex items-center gap-2'>
                        <div className='flex items-center gap-2 bg-component-surface border border-base-light/20 rounded-md pl-3 pr-1 py-1'>
                            <div className='flex items-center gap-2 text-base-light border-r border-base-light/20 pr-2 mr-1'>
                                ...
                                <select 
                                    ...
                                    className='bg-transparent outline-none text-xs font-medium cursor-pointer uppercase tracking-wider'
                                >
                                    {columns.map(col => (
                        ...
                        <div className='flex items-center gap-2 bg-component-surface border border-base-light/20 rounded-md px-3 h-[48px] text-sm'>
                ...
                <div className='mt-4 h-[582px] overflow-y-auto overflow-x-auto rounded-sm border border-base-light/20 shadow-sm bg-component-surface'>
                ...
                <div className='flex justify-between items-center py-8 '>
                    ...
                    <div className='flex items-center gap-4'>
                        <button 
                            className='button-accent px-4 py-2 disabled:opacity-50 disabled:cursor-not-allowed'
                        ...
                        <div className='flex items-center gap-2 font-medium text-sm text-base-light'>
                            <span className='text-base'>Page {currentPage}</span>
                            <span>of</span>
                            <span className='text-base'>{totalPages || 1}</span>
                        </div>
