...
export default function History() {
    ...
    return (
        <div className='flex relative overflow-x-hidden min-h-screen bg-background text-base font-body'>
            <main className="max-lg:px-4 px-16 flex flex-col gap-2 flex-1 w-full min-w-0">
                                ...
                                <Collection
                                    ...
                                    renderItem={(item) => (
                                        <>
                                            ...
                                            <td className="py-3 px-4 text-base-light text-xs font-mono whitespace-nowrap">
                                                {new Date(item.updatedAt).toLocaleString('en-US', { month: 'short', day: 'numeric', year: 'numeric', hour: '2-digit', minute: '2-digit' })}
                                            </td>
                                            <td className="py-3 px-4 font-medium text-base-light max-w-[200px] truncate sm:whitespace-normal">
                                                {item.fullName}
                                            </td>
                                        </>
                                    )}
                ...
                <div className='flex max-md:flex-col max-md:gap-6 justify-between items-center pt-6 pb-8 w-full'>
                    ...
                    <Pagination 
                        ...
                        onPageChange={(page) => setHistoryParams({ group: page })} 
                        isLoading={isLoading} 
                    />
                </div>
            </main>
